...
return [
    ...
    */
    ...
    'no_vk'                => 'Использование картинок с ВК запрещено (используйте imgur.com)!',
    'null_plate'           => 'Вы должны заполнить поле для номера!',
    ...
    'unique_plate'          => 'Такой номер уже занят!',
    ...
    */
    ...
    'attributes' => include(resource_path('lang/ru').'/attributes.php'),
];
