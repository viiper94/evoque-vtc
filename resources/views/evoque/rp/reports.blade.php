...
@section('content')
    ...
    <div class="container pt-5">
        ...
        @can('viewAll', \App\RpReport::class)
            <h2 class="mt-3 text-primary ml-3 text-center">Отчёты рейтинговых перевозок</h2>
        @else
            ...
            <section class="convoy-note pb-5 pt-5 m-auto">
                ...
                <blockquote class="blockquote text-center mb-5 mt-5">
                    ...
                    <ol class="text-left ml-5 mr-1">
                        ...
                        <li>Лидером за 10 дней становится тот, кто в сумме (отвезенный километраж + бонус)<br>
