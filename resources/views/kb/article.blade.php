    ...
    <div class="container py-5">
        <section class="article-author mt-3 row">
            ...
            <div class="col">
                ...
                <h4>{{ $article->user->member ? $article->user->member->nickname : $article->user->name }}</h4>
            ...
            <div class="col-auto text-right">
                ...
                <p class="text-muted">Последнее обновление: {{ $article->updated_at->format('d.m.Y в H:i') }}</p>
            </div>
